...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference("Prospect.count") do
      post prospects_url, params: { prospect: { designer: @prospect.designer, industry: @prospect.industry, jobrole: @prospect.jobrole, location: @prospect.location } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { designer: @prospect.designer, industry: @prospect.industry, jobrole: @prospect.jobrole, location: @prospect.location } }
